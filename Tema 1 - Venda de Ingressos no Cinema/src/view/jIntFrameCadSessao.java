...
public class jIntFrameCadSessao extends javax.swing.JInternalFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jButtonCadastrarSala, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void carregarDadosFilme() {
        ...
        for (Filme lista1 : lista) {
            jCombFilme.addItem(lista1.getNomeFilme());
    ...
    private void carregarDadosSala() {
        ...
        for (Sala lista1 : lista) {
            jCombSala.addItem(lista1.getCodSala());
        }
    ...
    public void cadSessao() {
        try {
            ...
            Date hora = (Date) jCombHora.getSelectedItem();
            Date data = (Date) jDateChooser.getDate();
